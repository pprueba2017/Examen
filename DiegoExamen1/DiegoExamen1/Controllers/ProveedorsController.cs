...
namespace DiegoExamen1.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProveedor,Nombre,Descripcion")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProveedor,Nombre,Descripcion")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
